...
class OSMStyle():
    ...
    def __init__(self):
        ...
        self.colorDict["wayCasingColor"] = QColor(0x70, 0x7d, 0x05)
        ...
        self.colorDict["waterColor"] = QColor(0xaa, 0xd3, 0xdf)
        self.colorDict["adminAreaColor"] = QColor(0xac, 0x46, 0xac)
        self.colorDict["warningBackgroundColor"] = QColor(255, 0, 0, 200)
        self.colorDict["naturalColor"] = QColor(0x8d, 0xc5, 0x6c)
        self.colorDict["forestAreaColor"] = QColor(0xad, 0xd1, 0x9e)
        ...
        self.colorDict["commercialColor"] = QColor(0xf2, 0xda, 0xd9)
        self.colorDict["farmColor"] = QColor(0xee, 0xf0, 0xd5)
        self.colorDict["grassColor"] = QColor(0xcd, 0xeb, 0xb0)
    ...
    def initPens(self):
        ...
        pen = QPen()
        pen.setColor(self.getStyleColor("naturalColor"))
        pen.setWidth(2.0)
        self.penDict["naturalPen"] = pen
    ...
    def initStreetColors(self):
        self.colorDict[Constants.STREET_TYPE_MOTORWAY] = QColor(0xe8, 0x92, 0xa2)
        self.colorDict[Constants.STREET_TYPE_MOTORWAY_LINK] = QColor(0xe8, 0x92, 0xa2)
        self.colorDict[Constants.STREET_TYPE_TRUNK] = QColor(0xf9, 0xb2, 0x9c)
        self.colorDict[Constants.STREET_TYPE_TRUNK_LINK] = QColor(0xf9, 0xb2, 0x9c)
        self.colorDict[Constants.STREET_TYPE_PRIMARY] = QColor(0xfc, 0xd6, 0xa4)
        self.colorDict[Constants.STREET_TYPE_PRIMARY_LINK] = QColor(0xfc, 0xd6, 0xa4)
        self.colorDict[Constants.STREET_TYPE_SECONDARY] = QColor(0xf7, 0xfa, 0xbf)
        self.colorDict[Constants.STREET_TYPE_SECONDARY_LINK] = QColor(0xf7, 0xfa, 0xbf)
...
#        return S
    ...
    def getBrushForLanduseArea(self, tags, zoom):
        ...
        elif landuse == "village_green" or landuse == "recreation_ground":
    ...
    def getBrushForTourismArea(self, tags, zoom):
        ...
        if tourism == "camp_site" or tourism == "caravan_site":
            ...
            brush = self.getStyleBrush("residentialColor")
        else:
    ...
    def getBrushForLeisureArea(self, tags, zoom):
        ...
        if leisure == "nature_reserve":
            ...
            pen = self.getStylePen("naturalPen")
